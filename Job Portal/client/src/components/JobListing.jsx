        ...
        {/* Pagination */}
        {
          jobs.length>0 && (
            <div className='w-full flex items-center justify-center gap-3  mt-10'>
              ...
              <a onClick={()=>setCurrentPage(prev=>prev == Math.ceil(jobs.length/6) ? Math.ceil(jobs.length/6) : prev+1)} href="#job-listing"> <img className='h-4' src={assets.right_arrow_icon} alt="right_arrow_icon" /></a>
            </div>
          )
        }
      </section>
